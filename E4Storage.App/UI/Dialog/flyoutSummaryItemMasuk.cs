...
{
    public class flyoutSummaryItemMasuk
    {
        private DevExpress.XtraBars.Docking2010.Customization.FlyoutDialog flyoutDialog;
        private System.Windows.Forms.Form form;
        private FlyoutAction action;
        private dlgSummaryItemMasuk userControl;

        public flyoutSummaryItemMasuk(System.Windows.Forms.Form form, dlgSummaryItemMasuk userControl)
        {
            this.form = form;
            this.userControl = userControl;
            this.action = new FlyoutAction
            {
                Caption = "Summary Barang",
                Description = "Summary Barang"
            };
