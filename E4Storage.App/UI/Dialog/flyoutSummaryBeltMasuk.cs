...
{
    public class flyoutSummaryBeltMasuk
    {
        private DevExpress.XtraBars.Docking2010.Customization.FlyoutDialog flyoutDialog;
        private System.Windows.Forms.Form form;
        private FlyoutAction action;
        private dlgSummaryBeltMasuk userControl;

        public flyoutSummaryBeltMasuk(System.Windows.Forms.Form form, dlgSummaryBeltMasuk userControl)
        {
            this.form = form;
