...
{
    public class flyoutOptionStokMasuk
    {
        private DevExpress.XtraBars.Docking2010.Customization.FlyoutDialog flyoutDialog;
        private System.Windows.Forms.Form form;
        private FlyoutAction action;
        private dlgOptionStokMasuk userControl;

        public flyoutOptionStokMasuk(System.Windows.Forms.Form form, dlgOptionStokMasuk userControl)
        {
            this.form = form;
            this.userControl = userControl;
            this.action = new FlyoutAction
            {
                Caption = "Opsi Barang Masuk",
                Description = "Opsi Barang Masuk"
            };
