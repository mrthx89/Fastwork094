...
namespace Inventory.App.UI
{
    public partial class frmEntriStokPengembalian : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmEntriStokPengembalian_Load(object sender, EventArgs e)
        {
            ...
            {
                data.Saldo = Repository.StokKeluar.getSaldoStok(data.IDInventor, data.Tanggal, data.ID, Constant.TypeTransaction.stokPengembalian).Item2;
            }
            refreshLookUp();
        ...
        private void IDInventorSearchLookUpEdit_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    data.Saldo = Repository.StokKeluar.getSaldoStok(IDInventor, data.Tanggal, data.ID, Constant.TypeTransaction.stokPengembalian).Item2;
        ...
        private void TanggalDateEdit_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                data.Saldo = Repository.StokKeluar.getSaldoStok(data.IDInventor, TanggalDateEdit.DateTime, data.ID, Constant.TypeTransaction.stokPengembalian).Item2;
