...
namespace Inventory.App.UI
{
    partial class frmEntriVendor
    {
        ...
        private void InitializeComponent()
        {
            ...
            // TglEntriDateEdit
            // 
            this.TglEntriDateEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "TglEntri", true));
            ...
            // 
            this.vendorMasterBindingSource.DataSource = typeof(Inventory.App.Model.ViewModel.VendorMaster);
            // 
            // TglEditDateEdit
            // 
            this.TglEditDateEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "TglEdit", true));
            ...
            // 
            this.IDUserEntriSearchLookUpEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "IDUserEntri", true));
            ...
            // 
            this.IDUserEditSearchLookUpEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "IDUserEdit", true));
            ...
            // CodeTextEdit
            // 
            this.CodeTextEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "Code", true));
            ...
            // NameTextEdit
            // 
            this.NameTextEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "Name", true));
    ...
    "w+))+\\.*((\\w+-*)|(-*\\w+))+)|(((\\w+-*)|(-*\\w+))+))+\\.[A-Za-z]+";
            ...
            // 
            this.IDUserHapusSearchLookUpEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "IDUserHapus", true));
            ...
            // TglHapusDateEdit
            // 
            this.TglHapusDateEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.vendorMasterBindingSource, "TglHapus", true));
            ...
            this.Name = "frmEntriVendor";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Entri Supplier";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmEntriVendor_FormClosing);
            this.Load += new System.EventHandler(this.frmEntriVendor_Load);
